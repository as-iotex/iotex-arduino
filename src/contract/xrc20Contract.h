...
class Xrc20Contract
{
  public:
	/**
	 * @brief Generates the Ethereum ABI encoded data for calling the totalSupply() function of a XRC20 token
	 * 
	...
	/**
	 * @brief Generates the Ethereum ABI encoded data for calling the balanceOf() function of a XRC20 token
	 * 
	...
	/**
	 * @brief Generates the Ethereum ABI encoded data for calling the transfer() function of a XRC20 token
	 * 
