...
void Xrc20Contract::generateCallDataForBalanceOf(uint8_t address[ETH_ADDRESS_SIZE], uint8_t data[36])
{
    uint8_t *it = data;
...
void Xrc20Contract::generateCallDataForTransfer(uint8_t owner[ETH_ADDRESS_SIZE], uint64_t value, uint8_t data[68])
{
    uint8_t *it = data;
