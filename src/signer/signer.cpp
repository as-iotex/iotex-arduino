...
void Signer::getEthereumMessageHash(const uint8_t *pMsg, size_t length, uint8_t hash[IOTEX_HASH_SIZE])
{
...
void Signer::getPublicKey(const uint8_t privateKey[IOTEX_PRIVATE_KEY_SIZE], uint8_t publicKey[IOTEX_PUBLIC_KEY_SIZE])
{
...
void Signer::signMessage(const uint8_t *message, size_t size, const uint8_t privateKey[IOTEX_PRIVATE_KEY_SIZE], uint8_t signature[IOTEX_SIGNATURE_SIZE])
{
