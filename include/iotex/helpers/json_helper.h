...
namespace Iotex
{
    namespace json
    {
        struct JsonProp
        {
            ...
            JsonProp(reflection::CppType type, IotexString name) : type(type),
                                                        name(name), 
                                                        _initialized(false)
            {}
            ...
            protected:
                ...
                {
                    if (
                        type == reflection::CppType::C_STRING || 
                        type == reflection::CppType::STRING || 
                        type == reflection::CppType::OBJECT || 
                        type == reflection::CppType::BYTES
                        )
                    {
                        return true;
                    }
        ...
        /**
         * @struct  StringJsonProp  Struct that represents a string json property using IotexString
         */
        struct StringJsonProp : JsonProp
        {
            StringJsonProp(IotexString name) : 
                JsonProp(reflection::CppType::STRING, name)
                {}
            
            StringJsonProp(StringJsonProp&& orig) noexcept: 
                JsonProp(std::move(orig))
                {}
        ...
        {
            Uint8JsonProp(IotexString name) : 
                JsonProp(reflection::CppType::UINT8, name)
                {}
            
            Uint8JsonProp(Uint8JsonProp&& orig) noexcept: 
                JsonProp(std::move(orig))
                {}
        ...
        {
            Uint64JsonProp(IotexString name) : 
                JsonProp(reflection::CppType::UINT64, name)
                {}
            
            Uint64JsonProp(Uint64JsonProp&& orig) noexcept: 
                JsonProp(std::move(orig))
                {}
        ...
        {
            BytesJsonProp(IotexString name) : 
                JsonProp(reflection::CppType::BYTES, name)
                {}
        ...
        struct BoolJsonProp : JsonProp
        {
            BoolJsonProp(IotexString name): 
                JsonProp(reflection::CppType::BOOLEAN, name)
                {}
        ...
        struct ArrayJsonProp : JsonProp
        {
            ArrayJsonProp(IotexString name): 
                JsonProp(reflection::CppType::ARRAY, name)
                {}
        };
